...
# Leaving the TODOs here as in the starter code cause errors in my notebook
# So, I had to rearrange the structure of the code in this file to get it to run in the notebook.
def clean_data(data):
